...
export function buildAsmInstructionRR(opcode, $1, $2) {
...
/** $1->rd $2->rs $3->rt **/
export function buildAsmInstructionRRR(opcode, rd, rs, rt) {
...
/** $1->rt $2->rs  **/
export function buildAsmInstructionRRN(opcode, rt, rs, num) {
...
export function buildAsmInstructionRN(opcode, $1, num) {
...
export function buildAsmInstructionN(opcode, num) {
    if (opcode == "j")
...
export function buildAsmInstructionR(opcode, $1) {
