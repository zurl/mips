...
var opcodeTableOffsetRN = new Map([
    [0x7, "bgtz"],
    [0x6, "blez"],
    [0xf, "lui"],
]);
var functTableRRR = new Map([
    [0x20, "add"],
    [0x21, "addu"],
    [0x22, "sub"],
    [0x23, "subu"],
...
var functTableRRS = new Map([
    [0x00, "sll"],
    [0x02, "srl"],
    [0x03, "sra"],
]);
var functTableRR = new Map([
    [0x09, "jalr"],
    [0x18, "mult"],
    [0x19, "multu"],
    [0x1a, "div"],
