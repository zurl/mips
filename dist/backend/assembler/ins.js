...
const ins = {
    ...
    rrs: (op, funct) => (rd, rs, rt, imm) => (op << 26) | (reg[rs] << 21) | (reg[rt] << 16) | ((imm & 0x1F) << 6) | funct,
};
const mapper = {
    st: ($1, $2, $3) => [0, $1, $2, 0],
    dti: ($1, $2, $3) => [$1, 0, $2, $3],
...
const op = {
    ...
    "srl": [ins.rrs(0x00, 0x00), mapper.dti, checker.rrn],
    "sll": [ins.rrs(0x00, 0x02), mapper.dti, checker.rrn],
