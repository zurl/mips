...
function disassmble(ins) {
    ...
    const rs = registerTable.get((ins & exports.$1_mask) >>> 21);
    const rt = registerTable.get((ins & exports.$2_mask) >>> 16);
    const rd = registerTable.get((ins & exports.$3_mask) >>> 11);
